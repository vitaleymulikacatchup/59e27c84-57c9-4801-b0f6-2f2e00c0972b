...
export default function Home() {
  return (
    <>
      ...
      <NumberGridTokenomics title="Key Metrics" description="Important values and stats regarding the tokenomics of MemePulse." tokenData={[{ value: "$1M", description: "Total Market Cap" }, { value: "1B", description: "Total Supply" }, { value: "500K", description: "Circulating Supply" }]} />
